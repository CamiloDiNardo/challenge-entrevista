...
const Hero = (): JSX.Element => {
  ...
  const GridItemHeadlineBlock = () => (
    <Box marginBottom={4} data-aos="fade-up">
      ...
      >
        Somos una firma de <b>contadores públicos y abogados,</b> con más de 1O
        años de experiencia en las áreas contable y legal.
        <br />
        Trabajamos para brindar a cada uno de nuestros clientes{" "}
        <b>estrategias y soluciones</b> adecuadas a su empresa y negocio.
      </Typography>
    </Box>
  );
